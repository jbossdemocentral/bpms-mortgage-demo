 ...
 */
@org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Mortgage Application")
public class Application  implements java.io.Serializable {

static final long serialVersionUID = 1L;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Validation Errors")
    ...
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Mortgage Interest APR")
    @org.kie.api.definition.type.Position(value = 6)
    private java.lang.Double apr;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Mortgage Amount")
    @org.kie.api.definition.type.Position(value = 5)
    private java.lang.Integer mortgageAmount;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Applicant")
    @org.kie.api.definition.type.Position(value = 0)
    private com.redhat.bpms.examples.mortgage.Applicant applicant;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Mortgage Amortization")
    @org.kie.api.definition.type.Position(value = 4)
    private java.lang.Integer amortization;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Down Payment")
    @org.kie.api.definition.type.Position(value = 3)
    private java.lang.Integer downPayment;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Property")
    @org.kie.api.definition.type.Position(value = 1)
    private com.redhat.bpms.examples.mortgage.Property property;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Appraisal")
