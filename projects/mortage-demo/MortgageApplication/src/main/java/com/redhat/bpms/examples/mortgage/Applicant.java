 ...
 */
@org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Mortgage Applicant")
public class Applicant  implements java.io.Serializable {

static final long serialVersionUID = 1L;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Credit Score")
    @org.kie.api.definition.type.Position(value = 3)
    private java.lang.Integer creditScore;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Annual Income")
    @org.kie.api.definition.type.Position(value = 2)
    private java.lang.Integer income;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Applicant Name")
    @org.kie.api.definition.type.Position(value = 0)
    private java.lang.String name;
    
    @org.kie.workbench.common.services.datamodeller.annotations.Label(value = "Social Security Number")
